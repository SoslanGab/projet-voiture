 ...
 */
final class Version20240207101237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE typevoiture (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE voiture (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, marque VARCHAR(25) DEFAULT NULL, modele VARCHAR(30) DEFAULT NULL, annee DATE DEFAULT NULL, couleur VARCHAR(20) DEFAULT NULL, prix_par_jour NUMERIC(10, 2) DEFAULT NULL, statut VARCHAR(30) DEFAULT NULL, UNIQUE INDEX UNIQ_E9E2810FC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
